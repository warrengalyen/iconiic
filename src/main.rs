...
BETA 0.0.1";
const USAGE: &str = "   iconiic ((-f <file path> (<size>) [--interpolate | --proportional]) (-o <output path> | -png <output path>)) | -h\n";
const EXAMPLES: &str = "    iconiic -f small.svg 16 20 24 -f big.png 32 64 -o output.ico
    iconiic -f image.png 32x12 64x28 48 --interpolate -png output.zip\n";
